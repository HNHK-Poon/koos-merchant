...
const WalletTransactionRecord = (props: IProps) => {
    const navigate = useNavigate();
    const goToTransaction = () => {
        navigate(`/wallettransaction/${props.id}`, { state: { isCreated: false } });
    };

    return (
        <div
            onClick={goToTransaction}
            className="flex justify-between items-center my-1.5 p-3 rounded-md shadow-sm"
        >
...
WalletTransactionRecord.propTypes = {};

export default WalletTransactionRecord;
