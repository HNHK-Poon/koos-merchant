  ...
  return {
    ...
    getAccount: (id: string) => {
      return new Promise((resolve, reject) => {
        rest
          .get(`${API_PREFIX}/user/merchant/all/${id}`, {})
          .then((res: any) => {
            resolve([null, res]);
          })
          .catch((err: any) => {
    ...
    getOwnMerchantList: () => {
      return rest.get(`api/v2/merchant`);
    },
    getMerchantWalletBalance: (merchantId: string) => {
      return rest.get(`api/v2/merchant/wallet/${merchantId}`);
    }
  };
};
